    ...
    <div class="card" style="background-color: #F9F9F9;">
                ...
                <div class="col-md-12 mt-3 table-wrapper" >
                    <table>
                        ...
                        <tr style="background-color: #DCD5D5; color: #ffffff;">
                            <td>Silica Institute</td>
                            <td> <a href=""> Login </a></td>
                        </tr>
                        <tr style="background-color: #DCD5D5; color: #ffffff;">
                            <td>Competition (<?php echo sizeof($get_client_details[0]['compititors_data']); ?>)    </td>
                            <td> <a href=""> User Guide </a></td>
                        </tr>
                        <tr style="background-color: #DCD5D5; color: #ffffff;">
                            <td>  Industry (0)   </td>
                            <td> <a href=""> Edit </a> |<a href=""> Pdf </a> |<a href=""> Word </a></td>
                        </tr>
                        <tr style="background-color: #DCD5D5; color: #ffffff;">
                            <td></td>
                ...
                <div class="body-content" style="padding:10px 15px 0px 15px;">
                    ...
                    foreach ($get_client_details[0]['client_news'] as $key => $news) { ?>
                        <h5 ><a href="#" style="color: <?php echo $get_client_details[0]['content_headline_color']; ?>;font-size: <?php echo $get_client_details[0]['content_headline_font_size']; ?>;font-family: <?php echo $get_client_details[0]['content_headline_font']; ?>">  <?php echo $news['head_line']; ?> </a></h5>
                         <h6 >Summary:</h6>
                         ...
                         <p>Edition : <span> <?php echo $news['publication_id']; ?> </span>, No of pages:<span> <?php echo $news['page_count']; ?></span></p>                   
                         <hr>
                    <?php }
                    ?>
