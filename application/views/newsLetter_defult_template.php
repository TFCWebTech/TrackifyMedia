...
<div class="container">
        ...
        <div class="row" id="hideThis">
            <div class="col-md-12 text-right mb-2">
                ...
                <button data-toggle="modal" data-target="#getEmail" id="getEmails" onclick="getEmail('<?php echo $get_client_data['client_id'];?>')" > <i class="fa fa-send"></i></button>
                <!-- <a class="send-button btn" href="<?php echo site_url('NewsLetter/sendMail/'.$get_client_data['client_id']);?>"> <i class="fa fa-send-o" ></i></a> -->
            </div>
        </div>
        <div class="card" id="content" style="background-color: #F9F9F9;">
                <div class="header" style="background-color: ; padding:5px 10px;">
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            ...
                            <td align="center">
                                <h5 ><a style="font-size:; color:;"> <?php echo $get_client_data['client_name']; ?> </a><br>
                ...
                <div class="body-content" style="padding:10px 15px 0px 15px;">
                    <h4 style="background-color: #cfbbbb; color: #ffffff; padding:4px;"> <?php echo $get_client_data['client_name']; ?></h4>
                    <?php foreach ($get_news_details as $news) { ?>
                        <div id="clientnewsContent-<?php echo $news['news_details_id']; ?>" style="display: block;">
                            <div style="display:flex; justify-content: space-between; padding:0px 10px 0px 0px;">
                                <h5>
                                    <a href="<?php echo site_url('NewsLetter/DisplayNews/'.$news['news_details_id']);?>" style="color:;font-size:;font-family:">  <?php echo $news['head_line']; ?> </a>
                                </h5>
                                <h6 class="showEdit">
                                    <div style="d-flex">
                                        ...
                                        <a style="color:red;" onclick="deleteNews('<?php echo $news['news_details_id'];?>', '<?php echo $get_client_data['client_id'];?>')">Delete</a> 
                                    </div>
                                </h6>
                            </div>
                            <h6>Summary:</h6>
                        ...
                        <div id="clientnewsContentEdit-<?php echo $news['news_details_id']; ?>" style="display: none;">
                            <div style="display:flex; justify-content: space-between; padding:0px 10px 0px 0px;">
                                ...
                                <h6 class="showEdit2">
                                    <div style="d-flex">
                                        <a class="btn border" onclick="updateNewsContent('<?php echo $news['news_details_id'];?>', '<?php echo $get_client_data['client_id'];?>')"> Update News</a> 
                                    </div>
                                </h6>
                            </div>
                ...
                <?php foreach ($get_comp_data as $compititor) { ?>
                    <div class="body-content" style="padding:10px 15px 0px 15px;">
                        ...
                        <?php foreach ($compititor['news'] as $key => $news) { ?>
                            <div id="competitornewsContent-<?php echo $news['news_details_id'] . '-' . $compititor['competitor_id']; ?>" style="display: block;">
                                <div style="display:flex; justify-content: space-between; padding:0px 10px 0px 0px;">
                                    <h5>
                                        <a href="<?php echo site_url('NewsLetter/DisplayNews/'.$news['news_details_id']);?>" style="color: ;font-size: ;font-family: ;">  
                            ...
                            <div id="competitornewsContentEdit-<?php echo $news['news_details_id'] . '-' . $compititor['competitor_id']; ?>" style="display: none;">
                                <div style="display:flex; justify-content: space-between; padding:0px 10px 0px 0px;">
                                    ...
                                    <h6 class="showEdit2">
                                        <div style="d-flex">
                                            <a class="btn border" onclick="updateNewsContent2('<?php echo $news['news_details_id'];?>', '<?php echo $get_client_data['client_id'];?>')"> Update News</a> 
                                        </div>
                                    </h6>
                                </div>
                ...
                <?php foreach ($get_industry_data as $Industry) { ?>
                    <div class="body-content" style="padding:10px 15px 0px 15px;">
                        ...
                        <?php foreach ($Industry['news'] as $key => $news) { ?>
                            ...
                            <div id="IndustrynewsContentEdit-<?php echo $news['news_details_id'] . '-' . $Industry['Industry_id']; ?>" style="display: none;">
                                <div style="display:flex; justify-content: space-between; padding:0px 10px 0px 0px;">
                                    ...
                                    <h6 class="showEdit2">
                                        <div style="d-flex">
                                            <a class="btn border" onclick="updateNewsContent3('<?php echo $news['news_details_id'];?>', '<?php echo $get_client_data['client_id'];?>')"> Update News</a> 
                                        </div>
                                    </h6>
                                </div>
                ...
                <?php } ?>
                <hr>
                <div class="col-md-12 news-footer" style="background-color:;">
                    <div class="d-flex justify-content-between" >
                            <div class="logo" style="text-align:left; ">
                                    <img src="https://pressbro.com/News/assets/img/mediaLogo.png" alt="logo" style="width:100px;  padding:5px;"> <br>
                            </div>
                        <div class="footer" style="text-align:center; ">
                        <!-- <p style="font-size:; color:;"><?php echo $get_client_data['client_name']; ?></p> -->
                        </div>
