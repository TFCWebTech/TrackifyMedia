...
<body id="page-top" onload="setDefaultDate()">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item ">
                <a class="nav-link" href="<?php echo site_url('ManageClient');?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Manage Clients</span></a>
            </li>
            <li class="nav-item ">
                <a class="nav-link" href="<?php echo site_url('ManageAdmin');?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Manage Admin</span></a>
            </li>
            <li class="nav-item ">
                <a class="nav-link" href="<?php echo site_url('ManageReporter');?>">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                                    ...
                                    <?php
                                     if($this->session->userdata('super_admin_id')){ 
                                        ?>
                                        <div>
                                         Welcome, <?php echo $this->session->userdata('super_admin_id'); ?>
                                        </div>
                                    <?php } else{
                                        ?>
                                        <div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="logout-form" action="<?php echo site_url('SuperAdmin/Logout')?>" method="POST" >
                        <div class="row">
                            <div class="col-md-12">
                                <p class="text-left">Do you really want to logout !</p>
                            </div>
