                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mt-4">
                                ...
                                <div class="p-5">
                                    ...
                                    <form action ="<?php echo site_url('Login/userLogin')?>" Method="POST" class="user">
                                        <!-- <div class="radio_sec d-flex justify-content-center">
                                            <div>
                                                <input type="radio" name="type" id="Admin" value="Admin"  required checked> 
                                                <label for="Admin"> Admin</label>
                                            </div> &nbsp;&nbsp;&nbsp;&nbsp;
                                            <div>
                                                <input type="radio" name="type" id="Reporter" value="Reporter"  required > 
